...
CommandSpec App::get_search_spec() {
  ...
  spec.subcommands = {
      {"chats",
       "<query> [-n|--limit <count>] [-o|--offset <count>] [-v|--verbose]",
       ...
       {{"-n",
        ...
        {"-h", "--help", "", "Show search chats help message", {}}}},
      {"supergroups",
       "<query> [-n|--limit <count>] [-o|--offset <count>] [-v|--verbose]",
       ...
       {{"-n",
        ...
        {"-o",
         ...
         {}},
        {"-v", "--verbose", "", "Show verbose search metadata", {}},
        {"-h", "--help", "", "Show search supergroups help message", {}}}},
      {"channels",
       "<query> [-n|--limit <count>] [-o|--offset <count>] [-v|--verbose]",
       ...
       {{"-n",
        ...
        {"-o",
         ...
         {}},
        {"-v", "--verbose", "", "Show verbose search metadata", {}},
        {"-h", "--help", "", "Show search channels help message", {}}}},
      {"msgs",
       "<query> [-c|--chat <chat_id>] [-n|--limit <count>] [-o|--offset "
       "<count>] [-v|--verbose]",
       ...
       {{"-c",
        ...
        {"-o",
         ...
         {}},
        {"-v", "--verbose", "", "Show verbose search metadata", {}},
        {"-h", "--help", "", "Show search msgs help message", {}}}},
      {"users",
       "<query> [-n|--limit <count>] [-o|--offset <count>] [-v|--verbose]",
       ...
       {{"-n",
        ...
        {"-o",
         ...
         {}},
        {"-v", "--verbose", "", "Show verbose search metadata", {}},
        {"-h", "--help", "", "Show search users help message", {}}}},
      {"files",
       "<query> [-t|--type <doc|photo|video|audio|all>] [-n|--limit <count>] "
       "[-o|--offset <count>] [-v|--verbose]",
       "Search file and media attachments",
       {{"-t",
         "--type",
         "<type>",
         "Filter attachment type: doc, photo, video, audio, all (default: doc)",
        ...
        {"-o",
         ...
         {}},
        {"-v", "--verbose", "", "Show verbose search metadata", {}},
        {"-h", "--help", "", "Show search files help message", {}}}}};
