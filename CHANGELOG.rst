...
* Streamlined headless environment handling by generating ``/tmp/grm-login-qr.html`` with clear, concise instructions to download or open the file in a browser, removing un-scannable terminal block QR rendering.
